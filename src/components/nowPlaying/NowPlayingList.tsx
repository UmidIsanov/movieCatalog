...
const NowPlayingFilmsList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const url =
        "https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=1s";
      const options = {
        method: "GET",
        headers: {
  ...
  return (
    <div>
      <h2 className="Wrapper-title">Now Playing </h2>{" "}
...
export default NowPlayingFilmsList;
